// Embedding adapters: OpenAI (fetch-based) and Mock (deterministic).
// Env vars used: OPENAI_API_KEY (optional for OpenAIEmbeddings).
...
export class MockEmbeddings implements EmbeddingAdapter {
  // Deterministic mock: hash text to fixed-size vector for testing.
  async embed(text: string): Promise<number[]> {
