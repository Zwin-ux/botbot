...
function getSetupSuggestion(feature) {
  ...
  switch (feature) {
    case "retro":
      ...
      desc =
        "You haven't set up any retrospectives yet. Would you like to schedule one now?";
    ...
    case "standup":
      ...
      desc =
        "You haven't set up any daily standups yet. Would you like to set one up now?";
    ...
    case "reminder":
      ...
      desc =
        "You don’t have any reminders yet. Want to create your first reminder?";
    ...
    case "game":
      title = "Let’s Play!";
      desc =
        "Bring some magic to your channel! Try saying: **start emoji race** or **start story** to get the fun started. 🎉";
