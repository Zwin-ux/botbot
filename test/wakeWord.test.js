...
jest.mock("../src/utils/cache.js", () => ({
  userCache: { get: jest.fn(), set: jest.fn(), has: jest.fn() },
  intentCache: { get: jest.fn(() => null), set: jest.fn() },
}));

jest.mock("../src/utils/rateLimiter.js", () => ({
  rateLimiter: { checkLimit: jest.fn(() => ({ allowed: true })) },
}));
...
jest.mock("../src/utils/embedUtils.js", () => ({
  createEmbed: jest
    .fn()
    .mockImplementation(({ title, description, color }) => ({
      title,
      description,
      color,
    })),
